...
export const TEMPLATES: StampTemplate[] = [
  ...
  },
  {
    ...
    project: {
      ...
      elements: [
        shape({ shape: 'rectangle', width: 55, height: 25, strokeColor: '#1F4E8B', strokeWidth: 1.2, filled: false }),
        text({ text: 'COBALT & FINCH', y: -4, fontSize: 4, fontWeight: 700, letterSpacing: 0.5, color: '#1F4E8B' }),
        text({ text: 'STUDIO', y: 4, fontSize: 3.2, letterSpacing: 3, color: '#1F4E8B' }),
      ],
    },
  },
  {
  ...
  },
  {
    ...
    project: {
      ...
      outlineSuppressed: true,
      elements: [
        shape({ shape: 'rectangle', width: 50, height: 26, strokeColor: '#C4282D', strokeWidth: 1.2, filled: false }),
        text({ text: 'HANDLE WITH CARE', y: -4, fontSize: 2.9, fontWeight: 700, letterSpacing: 0.5, color: '#C4282D' }),
        shape({ shape: 'line', width: 36, height: 0.5, y: 0, strokeColor: '#C4282D' }),
        text({ text: 'THIS SIDE UP', y: 6, fontSize: 3.3, letterSpacing: 1, color: '#C4282D' }),
      ],
    },
  },
  {
  ...
  },
  {
    ...
    project: {
      ...
      outlineSuppressed: true,
      elements: [
        shape({ shape: 'rectangle', width: 48, height: 20, strokeColor: '#1F4E8B', strokeWidth: 1.2, filled: false }),
        text({ text: 'REVIEWED', y: -3, fontSize: 4.5, fontWeight: 700, letterSpacing: 1, color: '#1F4E8B' }),
        text({ text: 'MS. RAMIREZ’S CLASS', y: 4, fontSize: 2.6, letterSpacing: 0.3, color: '#1F4E8B' }),
      ],
    },
  },
  {
    ...
    project: {
      ...
      outlineSuppressed: true,
      elements: [
        shape({ shape: 'circle', width: 34, height: 34, strokeColor: '#1F7A3D', strokeWidth: 1.2, filled: false }),
        shape({ shape: 'circle', width: 30, height: 30, strokeWidth: 0.8, strokeColor: '#1F7A3D' }),
        text({ text: 'SEAL', x: 0.2, y: 2.4, fontSize: 7, fontWeight: 500, letterSpacing: 1, color: '#1F7A3D' }),
      ],
    },
  },
  {
  ...
  },
  {
    ...
    project: {
      ...
      outlineSuppressed: true,
      elements: [
        shape({ shape: 'roundedRectangle', width: 44, height: 20, cornerRadius: 4, strokeColor: '#1F7A3D', strokeWidth: 1.2, filled: false }),
